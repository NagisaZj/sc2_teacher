...
def main(argv):
    ...
    OPT_A = tf.train.RMSPropOptimizer(float(1e-5), name='RMSPropA')
    OPT_C = tf.train.RMSPropOptimizer(float(1e-5), name='RMSPropC')
